    ...
    <div className="mt-12 grid gap-6 md:grid-cols-3 container mx-auto px-4 ">
      {reviews.map((review) => {
        ...
        return (
          ...
          >
            <p className="flex-1 text-[0.95rem] leading-relaxed text-foreground/80 text-justify
" >
              <span className="text-yellow font-bold text-3xl">“ </span>
              
              
              {displayedQuote}
                   <span className=" relative top-2 text-yellow font-bold text-3xl">” </span>
              ...
              {isLong && ( 
                <button
                  ...
                  className="ml-2 font-semibold text-yellow underline underline-offset-4 transition-opacity hover:opacity-70   text-justify
" 
                >
