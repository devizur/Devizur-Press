export const siteConfig = {
  ...
  socialProof: [
    ...
    {
      quote:
        "This book perfectly captures and solves many problems I've encountered with data across multiple organizations I've worked in. A clear system that helps cut through the noise and sanity checks the decision making process.\n\n Essential reading for any modern executive.",
      name: "Umut Omer",
